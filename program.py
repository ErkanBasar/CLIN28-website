...
programDay1 = [
               ...
               { 'time':'10:30 - 11:00 [Session 1: Social Media]',
				  'icon': 'fa-comment',
				  'presentations' : [				
										 {
               ...
               'presentations' : [
                                  ...
                                  'title': 'Coffee Break',
                                  'speakers':[''],
                                  'uniqueID':'CoffeeBreak1',
                                  'abstract':''
                                  },
                                  ]
               },
               { 'time':'11:30 - 13:00 [Session 2: Social Media]',
				  'icon': 'fa-comment',
				  'presentations' : [				
                                     {
               ...
               { 'time':'14:00 - 15:00 [Session 3: Text Generation]',
               'icon': 'fa-comment',
               'presentations' : [
                                  {
               ...
               'presentations' : [
                                  {
                                  'title': 'Discussion on potential joint project proposals',
                                  'speakers':[''],
                                  'uniqueID':'Discussion',
                                  'abstract':''
                                  },
               ...
               { 'time':'15.40-17.30 [Poster and Demonstration Session] accompanied with coffee',
               'icon': 'fa-files-o',
               'presentations' : [
                                  {
...
programDay2 = [
               ...
               { 'time':'9.30-11.00 [Session 4: Language Learning]',
               'icon': 'fa-comment',
               'presentations' : [
                                  {
